...
This document provides reusable structure templates for standard content types. The `@copywrite` agent loads these on demand when producing content that follows established patterns.
...
**Body**: [Develop each point with examples, data, or narrative]

**Takeaway**: [What the reader should do or think after reading]
...
CTA: [Like, subscribe, comment, or link]
```
...
**Proposed Copy**: [New string]

**Context**: [Where this appears and what the user just did]

**Purpose**: [What the user should understand or do next]
...
**Voice Notes**: [Why this choice aligns with brand voice]
```
...
When producing a standard content type (blog post, video script, or UI copy), load the appropriate template section above as a starting structure. Fill in each field with content specific to the task. The template ensures consistency across content pieces while leaving creative execution to the writer.
